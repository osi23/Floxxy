...
textCustomerName=Entry(customerFrame,font=('arial',16,'bold' ),bd=6,width=14,state='readonly')
...
textPhoneNo=Entry(customerFrame,font=('arial',16,'bold' ),bd=6,width=14,state='readonly')
...
textEmail=Entry(customerFrame,font=('arial',16,'bold' ),bd=6,width=14,state='readonly')
